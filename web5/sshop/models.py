...
if __name__ == "__main__":
    ...
    # This VIP user is only for checker, find other ways to be a VIP user!
    db.add(User(username="admin", mail="admin@admin.com",password=bcrypt.hashpw("************".encode('utf8'), bcrypt.gensalt()),isvip=True))
    db.commit()
